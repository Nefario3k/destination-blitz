<template>
  <label
    ...
    @click.stop="componentEmit('change')"
  ...
  >
    ...
    <span v-if="title" :class="textClass">{{ title }}</span>
  </label>
</template>
...
defineProps({
  ...
  textClass: {
    type: String,
    default: "capitalize elipsis text-sm text-dark-2 mb-0",
  },
});
const componentEmit = defineEmits(["change"]);
</script>
